    ...
    <view class="ei-calendar__container">
      <view class="ei-calendar__container__header">
        ...
        <view class="ei-calendar__container__header__date">
          ...
          <view class="ei-calendar__container__header__date__btn" hover-class="is-hover" :hover-start-time="20" :hover-stay-time="70" @click="toMonth(-1)">
          ...
          <view class="ei-calendar__container__header__date__edge today" hover-class="is-hover" :hover-start-time="20" :hover-stay-time="70" @click="toMonth(0)">今天</view>
        </view>
  ...
  methods: {
    ...
    toMonth(month) {
      ...
      if (month === 0) {
        ...
        this.currentDate = EDate.modify(this.currentDate, { m: month }).format('YYYY/MM');
        this.setShowMonthList(this.currentIndex);
      }
      this.$emit('date-change', this.currentDate, oldDate);
    }
