<template>
	...
	<view class="city-select">
		<scroll-view :scroll-top="scrollTop" scroll-y="true" class="city-select-main" id="city-select-main">
			<!-- 预留搜索-->
			<uni-search-bar radius="100" placeholder="请输入城市或拼音" clearButton="always" cancelButton="always" @confirm="search" />
			...
			<!-- 热门城市 -->
			<view class="hot-title" v-if="hotCity.length > 0 && !serachCity">历史访问城市</view>
