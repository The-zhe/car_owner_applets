<template>
	<view class="addCard">
		<view class="car001" style="z-index: 1;top:30rpx">
			<image class="car01" src="../static/img/car01.png"></image>
		</view>
		<view v-if="carUrl==''">
			<view class="car001" style="z-index: 2;top:64rpx">
				<image class="car02" src="../static/img/car02.png"></image>
			</view>
		...
		<view class="car001" style="z-index: 2;top:64rpx" v-else>
			<image :src="carUrl" class="car02 "></image>
		</view>
		...
		<view class="car002">
			...
			<view class="carbox">
				...
				<view class="add-border add-padding">
					<plate @listenPlateChange="plateChange" :defaultPlate="plateNumber"></plate>
				</view>
				...
				<view class="car-type flex-c-between">
					...
					<picker mode="date" :value="date" :start="startDate1" :end="endDate1"  @change="bindDateChange1">
						<view class="flex-c-center">
							{{latestMaintenanceDate}}<text class="iconfont iconyoujiantou"></text>
						</view>
					</picker>
				</view>
				<view class="car-type flex-c-between">
				...
				<view class="car-type flex-c-between">
					...
					<picker mode="date" :value="date" :start="startDate1" :end="endDate1"  @change="bindDateChange2">
						<view class="flex-c-center">
							{{registrationDate}}<text class="iconfont iconyoujiantou"></text>
						</view>
					</picker>
				</view>
				<view class="car-type flex-c-between">
		...
		<view class="fixed-btn{">
			<view class="submit-btn" @click="saveCar">保存</view>
		</view>
	</view>
				...
				wx.chooseImage({
					...
					success: function(res) {
						...
						for (var i = 0; i < res.tempFilePaths.length; i++) {
							...
							//图片路径可自行修改
							uploadFile(res.tempFilePaths[i], 'cbb/' + nowTime + '/',
								function(result) {
									that.carUrl=result
