<template>
	<view class="comment">
		...
		<view class="comment_text">用户的描述</view>
		<view class="comment_image">
			<view class="img_box" v-for="(item, index) in uploadImages" :key="index"><image class="image" :src="item.url" /></view>
		</view>
	</view>
</template>
