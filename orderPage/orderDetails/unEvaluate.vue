<template>
	<view class="uneva">
		<view class="untalk_type">
			<view class="type_title">
				<view class="type_text">待评价</view>
			</view>
			<view class="type_img"><image src="../../static/img/img/tab/untalk.png" mode=""></image></view>
		</view>
		<view class="untalk_shop">
		...
		<view class="untalk_total">立即评价</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		show(index){
			console.log('show',index,this.isShow)
